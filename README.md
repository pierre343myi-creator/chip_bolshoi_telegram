...
git clone https://github.com/pierre343myi-creator/chip_bolshoi_telegram.git
cd chip_bolshoi_telegram
...
В проекте уже есть готовый файл службы `deploy/bolshoi-bot.service` — он рассчитан на пользователя `bolshoi-bot` и папку `/home/bolshoi-bot/chip_bolshoi_telegram` (ровно туда вы склонировали проект на шаге 3.4), поэтому копируется без изменений:

```bash
sudo cp /home/bolshoi-bot/chip_bolshoi_telegram/deploy/bolshoi-bot.service \
        /etc/systemd/system/
